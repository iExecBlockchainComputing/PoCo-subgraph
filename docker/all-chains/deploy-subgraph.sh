...
graph deploy viviani/poco subgraph.viviani.yaml --node http://127.0.0.1:13320 --ipfs http://127.0.01:5001 --version-label 0.0.1
...
graph deploy bellecour/poco subgraph.bellecour.yaml --node http://127.0.0.1:13420 --ipfs http://127.0.01:5001 --version-label 0.0.1
