...
FORK_BLOCK=${forkBlockNumber}`,
        ...
        // Update networks.json file if NETWORK_NAME is provided
        if (networkName && existsSync(networksFilePath)) {
            ...
            try {
                ...
                if (networksData[networkName]) {
                    console.log(
                        `Updating startBlock for network '${networkName}' to ${forkBlockNumber}`,
                    );
